module github.com/opensourceways/robot-atomgit-label
...
replace github.com/opensourceways/community-robot-lib v0.0.0-20220118064921-28924d0a1246 => ../community-robot-lib
