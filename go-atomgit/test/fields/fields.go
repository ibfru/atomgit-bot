...
func main() {
	...
	for _, tt := range []struct {
		...
		{"users/octocat", &atomgit.User{}},
		{"user", &atomgit.User{}},
		{"users/willnorris/keys", &[]atomgit.Key{}},
		{"orgs/google-test", &atomgit.Organization{}},
		{"repos/google/go-github", &atomgit.Repository{}},
		{"repos/google/go-github/issues/1", &atomgit.Issue{}},
		{"/gists/9257657", &atomgit.Gist{}},
	} {
