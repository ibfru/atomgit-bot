...
func failIfNotStatusCode(t *testing.T, resp *atomgit.Response, expectedCode int) {
...
func getOAuthAppClient(t *testing.T) *atomgit.Client {
	...
	tp := atomgit.BasicAuthTransport{
		Username: strings.TrimSpace(username),
		Password: strings.TrimSpace(password),
	}

	return atomgit.NewClient(tp.Client())
}
