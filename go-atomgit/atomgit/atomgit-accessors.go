...
func (a *AccessEvent) GetRepo() *Repository {
	if a == nil {
		return nil
	}
	return a.Repo
...
func (p *Repository) GetOrgAndRepo() (string, string) {
...
// GetID returns the ID field if it's non-nil, zero value otherwise.
func (p *PullRequestComment) GetID() string {
	if p == nil || p.ID == nil {
		return ""
	}
	return *p.ID
...
// GetID returns the ID field if it's non-nil, zero value otherwise.
func (p *PullRequestReview) GetID() string {
	if p == nil || p.ID == nil {
		return ""
	}
	return *p.ID
...
// GetSize returns the Size field if it's non-nil, zero value otherwise.
func (r *Repository) GetSize() float64 {
	if r == nil || r.Size == nil {
		return 0
	}
	return *r.Size
