...
func (bot *robot) handleCheckPR(e *atomgit.NoteEvent, cfg *botConfig, log *logrus.Entry) error {
	if !e.IsPullRequest() ||
		!e.IsPROpen() ||
...
func (bot *robot) tryMerge(e *atomgit.NoteEvent, cfg *botConfig, addComment bool, log *logrus.Entry) error {
